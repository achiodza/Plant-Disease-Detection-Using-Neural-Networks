...
IMG_SIZE = 50
LR = 1e-3
MODEL_NAME = 'newmodel-{}-{}.model'.format(LR, '2conv-basic')
...
def process_verify_data(filepath):
	...
	img = cv2.imread(filepath, cv2.IMREAD_COLOR) #reading image object
...
def analysis(filepath):
	...
	elif np.argmax(model_out) == 1: str_label = 'Bacterial Blight'
	elif np.argmax(model_out) == 2: str_label = 'Early blight'
